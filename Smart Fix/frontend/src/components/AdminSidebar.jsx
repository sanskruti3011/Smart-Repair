import { Bell, ClipboardList, LayoutDashboard, MessageSquareWarning, Settings, Shield, Star, UserCog, Users } from "lucide-react";
...
const AdminSidebar = ({ links, onNavigate }) => (
  <aside className="w-full xl:w-72">
    <div className="surface-card sticky top-24 p-4">
      <div className="rounded-[24px] bg-accent/10 p-5">
        <p className="text-xs font-semibold uppercase tracking-[0.24em] text-accent">Admin Command</p>
        ...
        <p className="mt-3 text-sm leading-7 text-[rgb(var(--color-text-soft))]">
          Monitor users, providers, repair requests, support tickets, notifications, and system activity from one admin workspace.
        </p>
      </div>
